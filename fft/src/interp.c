...
const struct cmd_type cmd_table[] = {
    ...
    {"map", do_map, POS_DEAD, 0, LOG_NEVER, 0},
    {"join", do_join, POS_STANDING, 0, LOG_NEVER, 0},
    {"test", do_test, POS_STANDING, 0, LOG_NEVER, 0},
    {"north", do_north, POS_STANDING, 0, LOG_NEVER, 0},
    {"done", do_done, POS_STANDING, 0, LOG_NEVER, 0},
    ...
    {"nomap",   do_nomap,   POS_SLEEPING, 0,  LOG_NORMAL, 1},
    ...
    {"gocial",  do_gocial,  POS_STANDING, 0, LOG_NEVER, 0},
    ...
    {"job",   do_job,   POS_DEAD,     0, LOG_NORMAL, 1},
    {"gain",   do_gain,   POS_DEAD,     0, LOG_NORMAL, 1},

    {"attack", do_attack, POS_STANDING, 0, LOG_NEVER, 0},
    {"xmeteor", xmeteor, POS_STANDING, 0, LOG_NEVER, 0},
    /*
...
/*  { "unlock",        do_unlock,    POS_RESTING,     0,  LOG_NORMAL, 1 }, */
     ...
     * Combat commands.
     */
    {"throw stone", throw_stone, POS_FIGHTING, 0, LOG_NORMAL, 1},
    {"fdisp", do_fdisp, POS_DEAD, 0, LOG_NORMAL, 0},
