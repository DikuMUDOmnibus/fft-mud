...
typedef struct    map_char_data    MAP_CHAR_DATA;
...
#define SKILL_UNSET 0
#define SKILL_REACT 1
#define SKILL_MISC 2
#define SKILL_MOVE 3
#define SKILL_JOB 4
...
struct    job_type
{
    ...
    char *  jname;              /* the full name of the class  */
    int dep_1_job;
    int dep_1_lev;
    int dep_2_job;
    int dep_2_lev;
...
struct pc_race_type                 /* additional data for pc races    */
{
    ...
    sh_int  class_mult[4];  /* exp multiplier for class, * 100 */
 ...
 */
#define ITEM_TAKE         (A)
#define ITEM_WEAR_RIGHT   (B)
#define ITEM_WEAR_LEFT    (C)
#define ITEM_WEAR_BODY    (D)
#define ITEM_WEAR_ACCESSORY     (E)
#define ITEM_NO_SAC       (F)
#define ITEM_WEAR_FLOAT   (G)
...
#define WEAPON_GUN 16 
#define WEAPON_MACE 4 
#define WEAPON_AXE 5 
#define WEAPON_FLAIL 6 
#define WEAPON_WHIP 7 
#define WEAPON_POLEARM 8 
#define WEAPON_NINJA_SWORD 9 
#define WEAPON_KNIGHT_SWORD 10 
#define WEAPON_ROD 11 
#define WEAPON_STAVE 12
#define WEAPON_BOW 13
#define WEAPON_INST 14
#define WEAPON_DICT 15
#define WEAPON_STICK 17
#define WEAPON_BAG 18
#define WEAPON_CLOTH 19
...
/* FFT DATA!! */
    ...
    int job_id;
    int job_jp[MAX_JOB];
    int job_top_jp[MAX_JOB];
    int job_level[MAX_JOB];
    int team;
    int base_move;
    int jump;
    int main_group_num;
...
struct    skill_type
{
    ...
    char *    cast_text;        /* Wear off message for obects    */
    char *    d_cast_text;        /* Wear off message for obects    */
    int       type;
    int       jp_cost;
    int       job_num;
    char * desc;
 ...
 */
extern char * female_names[256];
extern char * monster_names[256];
extern char * male_names[256];

extern sh_int gsn_s00;
extern sh_int gsn_s01;
extern sh_int gsn_s02;
extern sh_int gsn_s03;
extern sh_int gsn_s04;
extern sh_int gsn_s05;
extern sh_int gsn_s06;
extern sh_int gsn_s07;
extern sh_int gsn_s08;
extern sh_int gsn_s09;
extern sh_int gsn_s10;
extern sh_int gsn_s11;
extern sh_int gsn_s12;
extern sh_int gsn_s13;
extern sh_int gsn_s14;
extern sh_int gsn_s15;
extern sh_int gsn_s16;
extern sh_int gsn_s17;
extern sh_int gsn_s18;
extern sh_int gsn_s19;
extern sh_int gsn_s20;
extern sh_int gsn_s21;
extern sh_int gsn_s22;
extern sh_int gsn_s23;
extern sh_int gsn_s24;
extern sh_int gsn_s25;
extern sh_int gsn_s26;
extern sh_int gsn_s27;
extern sh_int gsn_s28;
extern sh_int gsn_s29;
extern sh_int gsn_s30;
extern sh_int gsn_s31;
extern sh_int gsn_s32;
extern sh_int gsn_s33;
extern sh_int gsn_s34;
extern sh_int gsn_s35;
extern sh_int gsn_s36;
extern sh_int gsn_s37;
extern sh_int gsn_s38;
extern sh_int gsn_s39;
extern sh_int gsn_s40;
extern sh_int gsn_s41;

extern    sh_int    gsn_counter_tackle;
extern    sh_int    gsn_counter;
extern    sh_int    gsn_hamedo;
extern    sh_int    gsn_move_plus_1;
extern    sh_int    gsn_move_plus_2;
extern    sh_int    gsn_move_plus_3;
 ...
 * Utility macros.
 */
#define DIE(ch,msg) ({send_to_char(msg,ch); return; })
#define FSPELLDMG(sn,ch,victim) (f_mag_table[sn].multiplier * ch->MagAttack * (ch->Faith/100) * (victim->Faith/100)
...
#define TURN(ch) (ch->in_room->turn == ch)
...
#define GET_HITROLL(ch)    \
        ((ch)->hitroll+str_app[get_curr_stat(ch,STAT_PA)].tohit)
#define GET_DAMROLL(ch) \
        ((ch)->damroll+str_app[get_curr_stat(ch,STAT_PA)].todam)
...
#define JOB_SQUIRE 0
#define JOB_CHEMIST 1
#define JOB_KNIGHT 2
#define JOB_ARCHER 3
#define JOB_MONK 4
#define JOB_PRIEST 5
#define JOB_WIZARD 6
#define JOB_TIMEMAGE 7
#define JOB_SUMMONER 8
#define JOB_THIEF 9
#define JOB_MEDIATOR 10
#define JOB_ORACLE 11
#define JOB_GEOMANCER 12
#define JOB_LANCER 13
#define JOB_SAMURAI 14
#define JOB_NINJA 15
#define JOB_CALCULATOR 16
...
extern    const    struct    job_type        job_table      [MAX_JOB];
extern    const    struct    weapon_type     weapon_table   [];
extern    const    struct    f_spell         f_mag_table    [];
