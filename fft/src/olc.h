...
int flag_value			args ( ( const struct flag_type *flag_table,
				         						char *argument) );
int 	str_flag_value	args ( ( const struct flag_type *flag_table,
												char *argument) );
char 	*str_flag_string	args( ( const struct flag_type *flag_table, FLAG *bits ) );
...
DECLARE_OLC_FUN( oedit_modtype		);
DECLARE_OLC_FUN( oedit_modamount	);
